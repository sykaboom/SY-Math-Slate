...
import { ModerationConsolePanel } from "@features/governance/moderation/ModerationConsolePanel";
import { HostLiveSessionPanel } from "@features/collaboration/sharing/HostLiveSessionPanel";
import { ThemePickerPanel } from "@features/chrome/theming-ui/ThemePickerPanel";
import { PendingApprovalPanel } from "@features/chrome/toolbar/PendingApprovalPanel";
import {
  validatePanelPolicyDocument,
} from "@features/chrome/layout/windowing/panelBehavior.schema";
import {
  PANEL_RUNTIME_ROLES,
  type PanelBehaviorContract,
  type PanelPolicyEntry,
  type PanelRoleOverride,
} from "@features/chrome/layout/windowing/panelBehavior.types";
import {
