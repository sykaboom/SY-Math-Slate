# Task 373: Mod and Package Contract Lock
...
## Goal (Base Required)
- What to change:
  - Mod and Package Contract Lock를 P3 단계에서 실행 가능한 단위로 구현한다.
...
- v10/src/core/mod/contracts, v10/src/core/mod/package, v10/src/mod/packages
...
- [ ] AC-1: mod contract와 package manifest v1 고정
- [ ] AC-2: 필수 필드/검증 오류가 명확
- [ ] AC-3: contract 문서와 타입이 일치
