# Task 398: Abuse Rate-limit Cost Guardrails
...
## Goal (Base Required)
- What to change:
  - Abuse Rate-limit Cost Guardrails를 P9 단계에서 실행 가능한 단위로 구현한다.
...
- v10/src/core/trust, v10/src/core/extensions/providers, v10/src/app/api
...
- [ ] AC-1: abuse/rate-limit 제어 적용
- [ ] AC-2: provider 비용 가드레일 동작
- [ ] AC-3: 차단 시 안전 실패
