# Task 370: Keyboard Focus and Dispatch Core
...
## Goal (Base Required)
- What to change:
  - Keyboard Focus and Dispatch Core를 P2 단계에서 실행 가능한 단위로 구현한다.
...
- [ ] AC-1: keyboard 라우팅이 focus guard 하에 단일 경로
- [ ] AC-2: mode/package 전환이 command dispatch로 통일
- [ ] AC-3: 포커스 이탈 시 오입력 방지
