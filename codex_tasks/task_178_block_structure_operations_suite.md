...
- `v10/src/features/layout/dataInput/blockStructureOps.ts`
...
1) Step:
   - Command / click path: `cd v10 && npm run lint -- --max-warnings=0 -- src/features/layout/dataInput/blockStructureOps.ts src/features/layout/DataInputPanel.tsx`
...
- `cd v10 && npm run lint -- --max-warnings=0 -- src/features/layout/dataInput/blockStructureOps.ts src/features/layout/DataInputPanel.tsx`
