# Task 389: AI Queue and Teacher Review Contract
...
## Goal (Base Required)
- What to change:
  - AI Queue and Teacher Review Contract를 P7 단계에서 실행 가능한 단위로 구현한다.
...
- v10/src/features/approval, v10/src/features/platform/store/useSyncStore.ts, v10/src/core/extensions
...
- [ ] AC-1: 학생 질문이 항상 queue 경유
- [ ] AC-2: 교사 approve/edit/reject 계약 고정
- [ ] AC-3: audit metadata 저장
