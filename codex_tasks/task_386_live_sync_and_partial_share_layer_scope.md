# Task 386: Live Sync and Partial Share Layer Scope
...
## Goal (Base Required)
- What to change:
  - Live Sync and Partial Share Layer Scope를 P6 단계에서 실행 가능한 단위로 구현한다.
...
- v10/src/features/platform/store/useSyncStore.ts, v10/src/features/chrome/viewer, v10/src/features/editor/canvas
...
- [ ] AC-1: host-authoritative 라이브 동기화
- [ ] AC-2: partial share 최소 단위 layer 적용
- [ ] AC-3: 참여자 write 우회 차단
