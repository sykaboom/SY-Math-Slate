# Task 387: Access Modes and Moderation Gate
...
## Goal (Base Required)
- What to change:
  - Access Modes and Moderation Gate를 P6 단계에서 실행 가능한 단위로 구현한다.
...
- [ ] AC-1: anonymous/public/private 접근 정책 적용
- [ ] AC-2: 모더레이션 게이트 경유
- [ ] AC-3: host 권한 동작 보호
