# Task 380: Phase 4 Gate Closeout
...
## Goal (Base Required)
- What to change:
  - Phase 4 Gate Closeout를 P4 단계에서 실행 가능한 단위로 구현한다.
...
- [ ] AC-1: P4 UI host 정리가 회귀 없이 닫힘
- [ ] AC-2: 3개 화면군 desktop/tablet/mobile 기본 시나리오 통과
- [ ] AC-3: P5 진입 기준 문서화
