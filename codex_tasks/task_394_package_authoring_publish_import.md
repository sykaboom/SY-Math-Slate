# Task 394: Package Authoring Publish Import
...
## Goal (Base Required)
- What to change:
  - Package Authoring Publish Import를 P8 단계에서 실행 가능한 단위로 구현한다.
...
- [ ] AC-1: authoring schema assistant 동작
- [ ] AC-2: export/import roundtrip 성공
- [ ] AC-3: 스키마 위반 아티팩트 차단
