# Task 369: Input Gateway Pointer Wheel
...
## Goal (Base Required)
- What to change:
  - Input Gateway Pointer Wheel를 P2 단계에서 실행 가능한 단위로 구현한다.
...
- v10/src/core/mod, v10/src/features/input, v10/src/features/editor/canvas
...
- [ ] AC-1: pointer/wheel 입력이 정규화 gateway 경유
- [ ] AC-2: route handled/pass contract 적용
- [ ] AC-3: 직접 라우팅 경로가 제거됨
...
1) Step:
   - Command / click path:
     - rg -n routePointer\|routeWheel v10/src
   - Expected result:
     - AC-1, AC-2 만족
   - Covers: AC-1, AC-2
