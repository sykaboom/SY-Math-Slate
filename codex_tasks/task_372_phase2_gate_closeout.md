# Task 372: Phase 2 Gate Closeout
...
## Goal (Base Required)
- What to change:
  - Phase 2 Gate Closeout를 P2 단계에서 실행 가능한 단위로 구현한다.
...
- v10/src/core/mod, v10/src/features/input, v10/src/features/platform/extensions/commands
...
- [ ] AC-1: P2 라우팅/커맨드 SSOT가 닫힘
- [ ] AC-2: 입력/명령 회귀 매트릭스 통과
- [ ] AC-3: P3 진입 전 결함 목록이 0 또는 승인됨
