# Task 393: Mod Package Manager UI Core
...
## Goal (Base Required)
- What to change:
  - Mod Package Manager UI Core를 P8 단계에서 실행 가능한 단위로 구현한다.
...
- [ ] AC-1: 패키지 enable/disable/order UI 제공
- [ ] AC-2: runtime 반영이 결정적
- [ ] AC-3: 코드수정 없이 운영 가능
