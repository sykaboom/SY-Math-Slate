# Task 361: Program DAG and Scope Lock
...
## Goal (Base Required)
- What to change:
  - Program DAG and Scope Lock를 P0 단계에서 실행 가능한 단위로 구현한다.
...
- PROJECT_ROADMAP.md, PROJECT_CONTEXT.md, codex_tasks/batch_dispatch_plan_2026_02_21_phase0_9.md
...
- [ ] AC-1: 361~400 체인과 의존성이 로드맵/배치플랜에 반영됨
- [ ] AC-2: 중복/충돌 계획이 제거됨
- [ ] AC-3: 다음 태스크가 참조할 SSOT 문서가 고정됨
...
2) Step:
   - Command / click path:
     - rg -n 361\|400\|P0\|P9 PROJECT_ROADMAP.md codex_tasks/batch_dispatch_plan_2026_02_21_phase0_9.md
   - Expected result:
     - AC-3 만족 및 회귀 없음
   - Covers: AC-3
