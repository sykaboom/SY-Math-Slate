# Task 366: Dock Resolver and Snap Engine
...
## Goal (Base Required)
- What to change:
  - Dock Resolver and Snap Engine를 P1 단계에서 실행 가능한 단위로 구현한다.
...
- [ ] AC-1: edge snap 판단이 resolver 단일 경로로 동작
- [ ] AC-2: top/bottom/left/right 스냅 임계값이 정책화
- [ ] AC-3: 캔버스 영역 가림 없이 도킹 반영
