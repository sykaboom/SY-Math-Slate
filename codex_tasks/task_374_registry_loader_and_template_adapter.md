# Task 374: Registry Loader and Template Adapter
...
## Goal (Base Required)
- What to change:
  - Registry Loader and Template Adapter를 P3 단계에서 실행 가능한 단위로 구현한다.
...
- v10/src/core/mod/host, v10/src/core/mod/package, v10/src/mod/templates
...
- [ ] AC-1: registry loader가 결정적 순서로 package 로딩
- [ ] AC-2: template adapter가 단일 bridge로 작동
- [ ] AC-3: 오류 시 deterministic failure
