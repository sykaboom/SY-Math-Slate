...
- `v10/src/features/platform/store/**`
...
2) Step:
   - Command / click path:
     - `rg -n "A-|A\\+|fontSize|isAdvancedControls|TEXT_FONT_FAMILY_OPTIONS|wrapSelectionWithClass|handleApply|handleAutoLayout|unmatched" v10/src/features/chrome/layout/DataInputPanel.tsx`
...
4) Step:
   - Command / click path:
     - `git status --short -- v10/src/features/chrome/layout/DataInputPanel.tsx codex_tasks/task_105_datainput_font_edit_ui_refine.md`
...
- Roll-back:
  - `v10/src/features/chrome/layout/DataInputPanel.tsx` 단일 파일 revert로 이전 폰트 UI 복구 가능.
...
- `sed -n '1,340p' v10/src/features/chrome/layout/DataInputPanel.tsx`
- `sed -n '1,260p' /home/sykab/.codex/skills/sy-slate-architecture-guardrails/SKILL.md`
- `rg -n "간단|상세|캔버스에 적용|블록|preview|expandedBlockId|footer|action" v10/src/features/chrome/layout/DataInputPanel.tsx`
- `nl -ba v10/src/features/chrome/layout/DataInputPanel.tsx | sed -n '340,920p'`
- `nl -ba v10/src/features/chrome/layout/DataInputPanel.tsx | sed -n '920,1320p'`
- `ls -1 design_drafts`
...
- `rg -n "createTextSegment|fontSize|fontFamily|normalizeTextSegmentStyle" v10/src/features/chrome/layout/dataInput/blockDraft.ts`
- `sed -n '1,260p' v10/src/features/chrome/layout/dataInput/blockDraft.ts`
- `nl -ba v10/src/features/chrome/layout/DataInputPanel.tsx | sed -n '1,140p'`
- `nl -ba v10/src/features/chrome/layout/DataInputPanel.tsx | sed -n '320,420p'`
- `nl -ba v10/src/features/chrome/layout/DataInputPanel.tsx | sed -n '860,1020p'`
- `rg -n "FONT_SIZE|adjustTextSegmentFontSize|A-|A\\+|폰트 크기" v10/src/features/chrome/layout/DataInputPanel.tsx`
- `nl -ba v10/src/features/chrome/layout/DataInputPanel.tsx | sed -n '1,120p'`
- `nl -ba v10/src/features/chrome/layout/DataInputPanel.tsx | sed -n '350,450p'`
- `nl -ba v10/src/features/chrome/layout/DataInputPanel.tsx | sed -n '880,1060p'`
- `ls design_drafts | rg "layout_datainput_1440x1080.svg|layout_drafting_room_768x1024.svg|layout_drafting_room_1024x768.svg|layout_writer_shell_820x1180.svg|layout_writer_shell_1180x820.svg"`
- `rg -n "A-|A\\+|fontSize|isAdvancedControls|TEXT_FONT_FAMILY_OPTIONS|wrapSelectionWithClass|handleApply|handleAutoLayout|unmatched" v10/src/features/chrome/layout/DataInputPanel.tsx`
