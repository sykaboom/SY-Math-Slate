# Task 379: Affordance Accessibility Feedback
...
## Goal (Base Required)
- What to change:
  - Affordance Accessibility Feedback를 P4 단계에서 실행 가능한 단위로 구현한다.
...
- [ ] AC-1: pen/laser/eraser 조작 피드백 일관
- [ ] AC-2: fullscreen exit 경로 명확
- [ ] AC-3: compact 과부하 완화
