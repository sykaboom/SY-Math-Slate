# Task 385: Session Policy and Viewer Mode Resolver
...
## Goal (Base Required)
- What to change:
  - Session Policy and Viewer Mode Resolver를 P6 단계에서 실행 가능한 단위로 구현한다.
...
- [ ] AC-1: snapshot/live one-way/two-way 정책 스키마 지원
- [ ] AC-2: policy->viewer 모드 해석 결정적
- [ ] AC-3: 템플릿 하드코딩 분기 감소
...
- Risks:
  - 정책 해석 모호성
- Roll-back:
  - session policy resolver revert
