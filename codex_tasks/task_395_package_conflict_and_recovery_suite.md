# Task 395: Package Conflict and Recovery Suite
...
## Goal (Base Required)
- What to change:
  - Package Conflict and Recovery Suite를 P8 단계에서 실행 가능한 단위로 구현한다.
...
- v10/src/features/platform/mod-studio, v10/src/core/mod/package, scripts
...
- [ ] AC-1: conflict diagnostics surface 제공
- [ ] AC-2: compatibility checker 동작
- [ ] AC-3: studio recovery 가이드 작동
