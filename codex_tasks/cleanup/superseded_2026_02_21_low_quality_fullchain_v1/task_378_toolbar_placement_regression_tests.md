# Task 378: Toolbar Placement Regression Tests
...
## Goal (Base Required)
- What to change:
  - Implement Toolbar Placement Regression Tests as a bounded step in P1 toward mod-first steady state.
...
- [ ] AC-1: Toolbar Placement Regression Tests is implemented within declared scope.
