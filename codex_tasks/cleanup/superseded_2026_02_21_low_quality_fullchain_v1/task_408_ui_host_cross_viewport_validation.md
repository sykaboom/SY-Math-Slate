# Task 408: UI Host Cross Viewport Validation
...
## Goal (Base Required)
- What to change:
  - Implement UI Host Cross Viewport Validation as a bounded step in P4 toward mod-first steady state.
...
- [ ] AC-1: UI Host Cross Viewport Validation is implemented within declared scope.
