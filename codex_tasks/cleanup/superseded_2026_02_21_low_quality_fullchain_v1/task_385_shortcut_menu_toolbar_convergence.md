# Task 385: Shortcut Menu Toolbar Convergence
...
## Goal (Base Required)
- What to change:
  - Implement Shortcut Menu Toolbar Convergence as a bounded step in P2 toward mod-first steady state.
...
- v10/src/core/mod, v10/src/features/editor/canvas, v10/src/features/input, v10/src/features/platform/extensions/commands

Out of scope:
- No layout redesign in this phase.
...
- [ ] AC-1: Shortcut Menu Toolbar Convergence is implemented within declared scope.
