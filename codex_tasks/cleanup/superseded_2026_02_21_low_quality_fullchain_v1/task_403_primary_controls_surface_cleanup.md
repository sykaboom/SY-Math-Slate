# Task 403: Primary Controls Surface Cleanup
...
## Goal (Base Required)
- What to change:
  - Implement Primary Controls Surface Cleanup as a bounded step in P4 toward mod-first steady state.
...
- [ ] AC-1: Primary Controls Surface Cleanup is implemented within declared scope.
