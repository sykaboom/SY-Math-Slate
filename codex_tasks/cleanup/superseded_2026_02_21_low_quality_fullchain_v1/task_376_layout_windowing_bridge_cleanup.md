# Task 376: Layout Windowing Bridge Cleanup
...
## Goal (Base Required)
- What to change:
  - Implement Layout Windowing Bridge Cleanup as a bounded step in P1 toward mod-first steady state.
...
- [ ] AC-1: Layout Windowing Bridge Cleanup is implemented within declared scope.
