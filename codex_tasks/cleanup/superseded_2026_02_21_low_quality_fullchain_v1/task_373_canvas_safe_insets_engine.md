# Task 373: Canvas Safe Insets Engine
...
## Goal (Base Required)
- What to change:
  - Implement Canvas Safe Insets Engine as a bounded step in P1 toward mod-first steady state.
...
- [ ] AC-1: Canvas Safe Insets Engine is implemented within declared scope.
