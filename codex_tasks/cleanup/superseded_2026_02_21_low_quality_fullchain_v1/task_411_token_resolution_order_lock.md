# Task 411: Token Resolution Order Lock
...
## Goal (Base Required)
- What to change:
  - Implement Token Resolution Order Lock as a bounded step in P5 toward mod-first steady state.
...
- [ ] AC-1: Token Resolution Order Lock is implemented within declared scope.
