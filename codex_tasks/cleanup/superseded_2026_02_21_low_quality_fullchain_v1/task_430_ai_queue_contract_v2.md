...
## Goal (Base Required)
- What to change:
  - Implement AI Queue Contract v2 as a bounded step in P7 toward mod-first steady state.
...
- [ ] AC-1: AI Queue Contract v2 is implemented within declared scope.
