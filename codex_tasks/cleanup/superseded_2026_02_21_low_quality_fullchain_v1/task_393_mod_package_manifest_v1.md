# Task 393: Mod Package Manifest v1
...
## Goal (Base Required)
- What to change:
  - Implement Mod Package Manifest v1 as a bounded step in P3 toward mod-first steady state.
...
- [ ] AC-1: Mod Package Manifest v1 is implemented within declared scope.
