# Task 406: Affordance Consistency Pen Laser Eraser
...
## Goal (Base Required)
- What to change:
  - Implement Affordance Consistency Pen Laser Eraser as a bounded step in P4 toward mod-first steady state.
...
- v10/src/features/chrome/ui-host, v10/src/features/chrome/toolbar, v10/src/features/chrome/layout/windowing

Out of scope:
- No changes to core mod contracts in this phase.
...
- [ ] AC-1: Affordance Consistency Pen Laser Eraser is implemented within declared scope.
