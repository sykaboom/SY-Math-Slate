# Task 420: Session Policy Schema v1
...
## Goal (Base Required)
- What to change:
  - Implement Session Policy Schema v1 as a bounded step in P6 toward mod-first steady state.
...
- [ ] AC-1: Session Policy Schema v1 is implemented within declared scope.
