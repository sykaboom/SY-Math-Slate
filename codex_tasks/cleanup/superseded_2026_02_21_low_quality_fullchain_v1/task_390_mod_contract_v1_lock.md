...
## Goal (Base Required)
- What to change:
  - Implement Mod Contract v1 Lock as a bounded step in P3 toward mod-first steady state.
...
- [ ] AC-1: Mod Contract v1 Lock is implemented within declared scope.
