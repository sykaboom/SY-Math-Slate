# Task 371: Dock Resolver Contract
...
## Goal (Base Required)
- What to change:
  - Implement Dock Resolver Contract as a bounded step in P1 toward mod-first steady state.
...
- [ ] AC-1: Dock Resolver Contract is implemented within declared scope.
