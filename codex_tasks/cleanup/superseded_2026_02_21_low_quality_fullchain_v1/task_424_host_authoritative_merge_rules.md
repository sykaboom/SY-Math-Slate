# Task 424: Host Authoritative Merge Rules
...
## Goal (Base Required)
- What to change:
  - Implement Host Authoritative Merge Rules as a bounded step in P6 toward mod-first steady state.
...
- [ ] AC-1: Host Authoritative Merge Rules is implemented within declared scope.
