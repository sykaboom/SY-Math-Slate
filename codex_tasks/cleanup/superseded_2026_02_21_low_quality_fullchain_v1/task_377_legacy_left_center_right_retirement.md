# Task 377: Legacy Left Center Right Retirement
...
## Goal (Base Required)
- What to change:
  - Implement Legacy Left Center Right Retirement as a bounded step in P1 toward mod-first steady state.
...
- v10/src/features/chrome/layout, v10/src/features/chrome/toolbar, v10/src/features/platform/store, design_drafts

Out of scope:
- No new AI, sharing, or theme features in this phase.
...
- [ ] AC-1: Legacy Left Center Right Retirement is implemented within declared scope.
