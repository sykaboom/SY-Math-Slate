# Task 365: Risk Register and Rollback Matrix
...
## Goal (Base Required)
- What to change:
  - Implement Risk Register and Rollback Matrix as a bounded step in P0 toward mod-first steady state.
...
- PROJECT_ROADMAP.md, PROJECT_CONTEXT.md, codex_tasks governance docs, scripts boundary checks

Out of scope:
- No runtime behavior or user-facing feature changes in this phase.
...
- [ ] AC-1: Risk Register and Rollback Matrix is implemented within declared scope.
