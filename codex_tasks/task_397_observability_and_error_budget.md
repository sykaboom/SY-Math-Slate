# Task 397: Observability and Error Budget
...
## Goal (Base Required)
- What to change:
  - Observability and Error Budget를 P9 단계에서 실행 가능한 단위로 구현한다.
...
- v10/src/core/telemetry, v10/src/core/trust, v10/docs
...
- [ ] AC-1: 핵심 이벤트 계측 baseline 구축
- [ ] AC-2: error budget alert 정책 반영
- [ ] AC-3: 운영 지표 문서화
