# Task 378: Toolbar IA and Duplicate Elimination
...
## Goal (Base Required)
- What to change:
  - Toolbar IA and Duplicate Elimination를 P4 단계에서 실행 가능한 단위로 구현한다.
...
- [ ] AC-1: draw/playback/canvas 카테고리 책임 분리
- [ ] AC-2: 중복 버튼/행동 제거
- [ ] AC-3: 핵심 조작 discoverability 유지
