# Task 367: Viewport Redline and Interaction Regression
...
## Goal (Base Required)
- What to change:
  - Viewport Redline and Interaction Regression를 P1 단계에서 실행 가능한 단위로 구현한다.
...
- [ ] AC-1: 4개 태블릿 뷰포트 redline 수치가 스펙과 일치
- [ ] AC-2: drag->snap->recover 경로가 모두 reachable
- [ ] AC-3: close/recover 버튼 도달성 기준 통과
