# Task 399: Rollback Drills Runbooks and Certification Report
...
## Goal (Base Required)
- What to change:
  - Rollback Drills Runbooks and Certification Report를 P9 단계에서 실행 가능한 단위로 구현한다.
...
- v10/docs, PROJECT_ROADMAP.md, codex_tasks
...
- [ ] AC-1: rollback/restore playbook 완성
- [ ] AC-2: 운영 drills 결과 기록
- [ ] AC-3: mod-first certification report 생성
